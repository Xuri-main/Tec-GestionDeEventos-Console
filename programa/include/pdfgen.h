/**
 * Archivo: pdfgen.h
 * Descripcion: Este archivo contiene las definiciones de las funciones relacionadas con la generación de archivos PDF.
 *              Estas funciones permiten crear documentos PDF con texto, formas, imágenes y otros elementos gráficos.
 * Autor: AndresRenaud (https://github.com/AndreRenaud/PDFGen/releases/tag/0.1.0)
 * Incluido por: Jareck Levell C.
 * Fecha: 28/03/2026
 */
